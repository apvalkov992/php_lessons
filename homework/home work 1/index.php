...
/*  
//lesson №1 Самостоятельная работа
...
$my_name = "Vasiliy"; // Создать переменную содержащую своё имя
$$my_name = "Guziy"; // Создать переменную названием которой будет своё имя а значением фамилия
